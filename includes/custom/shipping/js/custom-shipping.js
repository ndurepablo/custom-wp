                            ...
                            for (let hoodId in cityData){
                                ...
                                hoodSelect.on('change', function() {
                                    ...
                                    if (hoodSelect.val() == slug){
                                        ...
                                        if ($.datepicker._getInst($('#custom_shipping_date')[0])) {
                                            $('#custom_shipping_date').datepicker('destroy');
                                        }
...
jQuery(document).ready(function($) {
    $('body').on('change', 'select[id="custom_shipping_cost"]', function() {
        let radioButton = $('input[name="radio_region"]')
        ...
        $.ajax({
            ...
            data: {
                ...
                radio_selected: radioButton.val()
            },
